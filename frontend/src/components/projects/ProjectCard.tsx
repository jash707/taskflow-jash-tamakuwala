...
export function ProjectCard({ project, onEdit, onDelete }: Props) {
  ...
  return (
    <div
      ...
      className="card p-5 flex flex-col gap-3 group hover:-translate-y-0.5 transition-transform cursor-pointer"
    >
      <div className="flex items-start justify-between gap-2">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className="font-semibold text-slate-900 dark:text-white group-hover:text-brand-600 dark:group-hover:text-brand-400 truncate transition-colors">
            {project.name}
          </span>
        </div>
